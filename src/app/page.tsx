...
export default async function Home() {
  ...
  return <main>
    ...
    <div className="container overlap">
      ...
      <section className="popular-agents"><div className="section-heading"><div><h2>Popular agents</h2><p>Trusted agents people are engaging with now.</p></div></div><div className="popular-carousel"><AgentTable agents={popularAgents} hideAgentId imageLed /></div></section>
