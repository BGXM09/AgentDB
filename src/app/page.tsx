...
export default async function Home() {
  ...
  return <main>
    <section className="hero-band"><div className="container"><h1>The BNB Agent Economy Explorer</h1><SearchBox /><p className="hero-help"><b>AgentDB:</b> Discover real ERC-8004 identities, capabilities and onchain activity.</p></div></section>
    <div className="container overlap">
      <section className="stats-card">
        <div className="metric-stack"><div><span className="metric-icon">A</span><p>INDEXED BSC AGENTS<b>{page.total.toLocaleString()}</b></p></div><div className="metric-secondary"><p>NETWORK<b>BNB Smart Chain Mainnet</b></p></div></div>
        <div className="metric-stack"><div><span className="metric-icon">T</span><p>AGENTDB TASKS<b>0</b></p></div><div className="metric-secondary"><p>VERIFIED HIRES<b>Not available</b></p></div></div>
